...
{
    public partial class EmployeeWeeklySalaryProcessSave : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["employeeid"] != null && Request.QueryString["date"] != null)
                {
                    ...
                    {
                        Response.Redirect("~/Modules/HRAndPayRoll/Transactions/EmployeeWeeklySalaryProcessList.aspx", false);
                    }
                }
                else
                {
