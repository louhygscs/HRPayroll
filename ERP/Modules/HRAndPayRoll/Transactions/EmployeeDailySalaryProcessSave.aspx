<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/Main.Master" AutoEventWireup="true" CodeBehind="EmployeeDailySalaryProcessSave.aspx.cs" Inherits="ERP.Modules.HRAndPayRoll.Transactions.EmployeeDailySalaryProcessSave" %>
                ...
                <div class="widget-content">
                    <form id="frmMain" runat="server" class="form-horizontal row-border">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <asp:CheckBox ID="chkbxIsPaid" runat="server" Text="" />
