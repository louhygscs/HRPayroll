...
<asp:Content ID="cBody" ContentPlaceHolderID="cphBody" runat="server">
   <!-- <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            ...
            <li class="current">
                <a href="<%=ResolveUrl("~/Modules/HRAndPayRoll/Masters/AllowanceList.aspx") %>" title="Allowance">Allowance</a>
            </li>
        </ul>
    </div> -->
    <!-- /Breadcrumbs line -->
			...
			<div class="addingbtn">
				<div class="btn-group">
					<span class="btn addButtons">
						...
						<a href="<%=ResolveUrl("~/Modules/HRAndPayRoll/Masters/AllowanceSave.aspx") %>">Add Allowance</a>
					</span>
        ...
        <div class="col-md-12">
            <div class="widget box">
				<!--<div class="widget-header">
                    <h4><i class="fa fa-list"></i>All List <span>Allowance</span></h4>
                ...
                <div class="widget-content">
					<div class="headingOftabel">
						<h4>All List <span>Allowance</span></h4>
					</div>
                    <form id="frmMain" runat="server">
                        <asp:GridView ID="gvAllowance" runat="server" AutoGenerateColumns="False" CssClass="table  table-bordered gvAllowance" OnPreRender="gvAllowance_PreRender">
                            <Columns>
                                <asp:BoundField HeaderText="Allowance" DataField="AllowanceName" HeaderStyle-Width="60%" HeaderStyle-HorizontalAlign="Left" />
                                ...
                                <asp:TemplateField HeaderText="Action" HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <a href="<%#"AllowanceSave.aspx?id="+Eval("AllowanceID") %>">
											<img  src="<%=ResolveUrl("~/Images/edit.svg") %>" class="svg" alt="edit sign"/>

										</a>
                                    <asp:LinkButton ID="btnDelete" runat="server" CommandArgument='<%#Eval("AllowanceID") %>' OnClick="btnDelete_Click" CssClass="btnDelete">
