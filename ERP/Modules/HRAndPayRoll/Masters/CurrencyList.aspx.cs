...
namespace ERP.Modules.HRAndPayRoll.Masters
{
    public partial class CurrencyList : System.Web.UI.Page
    {
        ...
        protected void gvCurrency_PreRender(object sender, EventArgs e)
        {
            try
            {
                ICurrencyService _IService = new CurrencyService();

                Result<List<Currency>> _Result = _IService.GetList();

                if (_Result.IsSuccess)
                {
                    gvCurrency.DataSource = _Result.Data;
                    gvCurrency.DataBind();
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_Result.IsSuccess)
                {
                    ...
                    gvCurrency_PreRender(gvCurrency, new EventArgs());
                }
                else
                {
