...
{
    public partial class EmployeeHourlySalaryProcessList : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SessionHelper.SelectMenuSession = "liEmployeeHourlySalaryProcess_liHR_liHRTransactions";
        ...
        private void FillSalaryProcess()
        {
            ...
            if (!string.IsNullOrEmpty(_MonthId))
            {
                ...
                Result<List<EmployeePaidSalarys>> _ResultCompletedSalaryProcess = _IEmployeePaidSalaryService.GetEmployeeCompletedPaidSalaryByMonth(CultureInfo.CurrentCulture.DateTimeFormat.GetMonthName(_Month), _Year, (int)SalaryType.Hourly);
                ...
                Result<List<EmployeePaidSalarys>> _ResultPendingSalaryProcess = _IEmployeePaidSalaryService.GetEmployeePendingSalaryByMonth(CultureInfo.CurrentCulture.DateTimeFormat.GetMonthName(_Month), _Month, _Year, (int)SalaryType.Hourly);
            ...
            ScriptManager.RegisterStartupScript(this, typeof(Page), "EmployeeHourlySalaryProcessList", "EmployeeHourlySalaryProcessList.InitailGridDataTable();", true);
        }
