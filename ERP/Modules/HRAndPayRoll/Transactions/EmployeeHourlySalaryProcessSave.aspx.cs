...
{
    public partial class EmployeeHourlySalaryProcessSave : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["employeeid"] != null && Request.QueryString["monthyear"] != null)
                {
                    ...
                    {
                        Response.Redirect("~/Modules/HRAndPayRoll/Transactions/EmployeeHourlySalaryProcessList.aspx", false);
                    }
                }
                else
                {
