<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/Main.Master" AutoEventWireup="true" CodeBehind="EmployeeHourlySalaryProcessList.aspx.cs" Inherits="ERP.Modules.HRAndPayRoll.Transactions.EmployeeHourlySalaryProcessList" %>

<asp:Content ID="cHead" ContentPlaceHolderID="cphHead" runat="server">
    <title>Employee Salary Process</title>
    <script src="<%=ResolveUrl("~/Scripts/Modules/HRAndPayRoll/Transactions/EmployeeHourlySalaryProcessList.js")%>"></script>
</asp:Content>
			...
			<div class="addingbtn">
				<div class="btn-group">
					<span class="btn addButtons">
						...
						<a href="<%=ResolveUrl("~/Modules/HRAndPayRoll/Transactions/EmployeeHourlySalaryProcessSave.aspx") %>">Add Employee Salary Process</a>
