<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/Main.Master" AutoEventWireup="true" CodeBehind="Attendance.aspx.cs" Inherits="ERP.Modules.HRAndPayRoll.Reports.Attendance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script src="<%=ResolveUrl("~/Scripts/Modules/HRAndPayRoll/Reports/Attendance.js")%>"></script>
</asp:Content>
