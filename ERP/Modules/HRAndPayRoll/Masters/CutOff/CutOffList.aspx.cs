    ...
    public partial class CutOffList : System.Web.UI.Page
    {
        ...
        protected void gvList_PreRender(object sender, EventArgs e)
        {
            try
            {
                ...
                Result<List<PayrollCutOff>> _Result = _IService.GetCutOffPeriods();
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Result<Boolean> _Result = _IService.DeleteCutOffPeriod(_entityId, SessionHelper.SessionDetail.UserID);

                if (_Result.IsSuccess)
                {
                    IHistoryService _IHistoryService = new HistoryService();
                    _IHistoryService.InsertHistory<Guid>(Convert.ToString(_entityId), TableType.EducationMaster, OperationType.Delete, _entityId, SessionHelper.SessionDetail.UserID);
                    ...
                    gvList_PreRender(gvList, new EventArgs());
                }
                else
                {
