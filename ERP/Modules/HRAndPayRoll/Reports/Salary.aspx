<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/Main.Master" AutoEventWireup="true" CodeBehind="Salary.aspx.cs" Inherits="ERP.Modules.HRAndPayRoll.Reports.Salary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script src="<%=ResolveUrl("~/Scripts/Modules/HRAndPayRoll/Reports/Salary.js")%>"></script>
</asp:Content>
