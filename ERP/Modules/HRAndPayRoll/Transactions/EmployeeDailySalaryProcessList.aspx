<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/Main.Master" AutoEventWireup="true" CodeBehind="EmployeeDailySalaryProcessList.aspx.cs" Inherits="ERP.Modules.HRAndPayRoll.Transactions.EmployeeDailySalaryProcessList" %>
...
<asp:Content ID="cHead" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script src="<%=ResolveUrl("~/Scripts/Modules/HRAndPayRoll/Transactions/EmployeeDailySalaryProcessList.js")%>"></script>
    <script>
            ...
            <div class="addingbtn">
                <div class="btn-group">
                    <span class="btn addButtons">
                        ...
                        <a href="<%=ResolveUrl("~/Modules/HRAndPayRoll/Transactions/EmployeeDailySalaryProcessSave.aspx") %>">Add Employee Salary Process</a>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Action" HeaderStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <a href="javascript:;" id="btnView" onclick="EmployeeHourlySalaryProcessList.RediectSalarySave('<%#Eval("EmployeeId")%>')" class="btnView"><i class="fas fa-eye" title="Click to View Employee Salary Process"></i></a>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Action" HeaderStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <a href="javascript:;" id="btnEdit" onclick="EmployeeHourlySalaryProcessList.RediectSalarySave('<%#Eval("EmployeeId")%>')" class="btnEdit">
