<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/Main.Master" AutoEventWireup="true" CodeBehind="EmployeeWeeklySalaryProcessList.aspx.cs" Inherits="ERP.Modules.HRAndPayRoll.Transactions.EmployeeWeeklySalaryProcessList" %>
...
<asp:Content ID="cHead" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script src="<%=ResolveUrl("~/Scripts/Modules/HRAndPayRoll/Transactions/EmployeeWeeklySalaryProcessList.js")%>"></script>
    <script>
			...
			<div class="addingbtn">
                <div class="btn-group">
                    <span class="btn addButtons">
                        ...
                        <a href="<%=ResolveUrl("~/Modules/HRAndPayRoll/Transactions/EmployeeWeeklySalaryProcessSave.aspx") %>">Add Employee Salary Process</a>
                        ...
                        <asp:UpdatePanel ID="upMain" runat="server">
                            <ContentTemplate>
                                <div class="form-group efirst">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" runat="server" id="txtDate" class="form-control input-width-xlarge txtDate"  readonly="readonly"/>
                                    </div>
                                </div>
                                <div class="form-actions">
                        <asp:Button ID="btnCollect" runat="server" CssClass="btnCollect btn btn-success" Text="Calculate" OnClick="btnCollect_Click" />
                            </div>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Action" HeaderStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <a href="javascript:;" id="btnView" onclick="EmployeeWeeklySalaryProcessList.RediectSalarySave('<%#Eval("EmployeeId")%>')" class="btnView"><i class="fas fa-eye" title="Click to View Employee Salary Process"></i></a>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Action" HeaderStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <a href="javascript:;" id="btnEdit" onclick="EmployeeWeeklySalaryProcessList.RediectSalarySave('<%#Eval("EmployeeId")%>')" class="btnEdit">
