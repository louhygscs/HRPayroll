...
{
    public partial class EmployeeShiftList : System.Web.UI.Page
    {
        #region Variables
        ...
        protected void gvEmployeeShift_PreRender(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    gvEmployeeShift.DataSource = _Result.Data;
                    gvEmployeeShift.DataBind();

                    if (gvEmployeeShift.Rows.Count > 0)
                    {
                        gvEmployeeShift.UseAccessibleHeader = true;
                        gvEmployeeShift.HeaderRow.TableSection = TableRowSection.TableHeader;
                    }
                }
                else
                {
