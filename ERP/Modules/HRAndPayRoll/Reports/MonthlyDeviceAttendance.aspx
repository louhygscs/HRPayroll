<%@ Page Title="" Language="C#" MasterPageFile="~/Modules/Main.Master" AutoEventWireup="true" CodeBehind="MonthlyDeviceAttendance.aspx.cs" Inherits="ERP.Modules.HRAndPayRoll.Reports.MonthlyDeviceAttendance" %>

<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=15.0.0.0, Culture=neutral, PublicKeyToken=89845DCD8080CC91" Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <title>Monthly Device Attendance</title>
    ...
    <script src="<%=ResolveUrl("~/Scripts/Modules/HRAndPayRoll/Reports/MonthlyDeviceAttendance.js")%>"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <!-- /Breadcrumbs line -->
    <div class="page-header">
		<div class="pageHeading">
			<h3>Monthly Device Attendance</h3>
		</div>
    </div>
    <div class="row">
        <div class="col-md-12">
